...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-171613327-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-171613327-1');
</script>

  <title>Alexandru Cronț - Index</title>
  <meta content="I’d describe myself as being very resourceful and ambitious at the same time. I find solutions, get creative and solve problems without needing the help of coworkers or managers. I know when to ask for help and I don’t stay quiet if I do need assistance. But when it is possible to handle something without occupying the time of others, I do it and I consider myself very good at it. " name="descriptison">
  <meta content="Alex, Alex Cront, Alexanddru, Marian, Cronț, Cront, Alexandru Cront, Alexandru Cronț, Developer, Engineer, Programmer, Professional, AUTOSAR, C, Embedded, Coding, Degree, Debugging, Agile, ASPICE, Senior, Leader, team," name="keywords">
    ...
    <div class="d-flex flex-column">
      ...
      <nav class="nav-menu">
        <ul>
          ...
          <li><a href="#programming_skills"><i class="bx bx-server"></i>Programming skills</a></li>
<!--           <li><a href="#services"><i class="bx bx-server"></i> Services</a></li> -->
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in" alt="Cront Alexandru">
      <h1>Alex Cronț</h1>
      <p>I'm a <span class="typed" data-typed-items="Engineer, Developer, Programmer"></span></p>
    </div>
  </section><!-- End Hero -->
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4" data-aos="fade-right">
            <img src="assets/img/profile-img.jpg" class="img-fluid" alt="Cront Alexandru">
          </div>
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="icofont-rounded-right"></i> <strong>Birthday:</strong> 4 August 1994</li>
                  <li><i class="icofont-rounded-right"></i> <strong>Website:</strong> www.alexcront.com</li>
                  <li><i class="icofont-rounded-right"></i> <strong>Phone:</strong> +34 641 48 81 52</li>
                  <li><i class="icofont-rounded-right"></i> <strong>City:</strong> Barcelona, Spain</li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="icofont-rounded-right"></i> <strong>Email:</strong> crontalexandru@gmail.com</li>
                  <li><i class="icofont-rounded-right"></i> <strong>Freelance:</strong> Available</li>
                </ul>
              </div>
            </div>
            <p>
              I am ambitious and driven. Throughout faculty, I was active in League of students of the Faculty of Automatic Control and Computer
Engineering, representing the students in the Faculty Council and University Senate, worked part time, and still managed to graduate at the top of my class. Due to my dedication and involvement I was chosen as the president of LSAC and the members of the NGO were constantly looking up to me for advice.
            </p>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="progress">
              <span class="skill">Debugging <i class="val">75%</i></span>
              <div class="progress-bar-wrap">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="progress">
              <span class="skill">Agile <i class="val">80%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="resume-item pb-0">
              ...
              <p><em>Innovative and deadline-driven Embedded Software Engineer with 3+ years of experience and strong knowledge of AUTOSAR, working for several OEMs and Tier1 suppliers in the automotive SW sector, in Application and BSW, adapting quickly to changes.</em></p>
              <ul>
                <li>Barcelona, Spain</li>
                <li>+34 641 48 81 52</li>
                <li>crontalexandru@gmail.com</li>
              </ul>
            </div>

            <h3 class="resume-title">Education</h3>
            <div class="resume-item">
              <h4>Master of Distributed Systems &amp; Web Technologies</h4>
              <h5>2017 - 2019</h5>
              <p><em>Faculty of Automatic Control and Computer Engineering</em></p>
            ...
            <div class="resume-item">
              <h4>Bachelor of Computers Science &amp; Information Technology</h4>
              <h5>2013 - 2017</h5>
              <p><em>Faculty of Automatic Control and Computer Engineering</em></p>
              <p><em>"Gheorghe Asachi" Technical University, Iași, Romania</em></p>
...
<!--     <section id="portfolio" class="portfolio section-bg">
    ...
    <section id="tools" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Tools</h2>
          <p>Until now I used several tools in worder to have quality in my work.</p>
        </div>

        <div class="row">
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
            <div class="icon"><i class="icofont-computer"></i></div>
            <h4 class="title"><a href="">DaVinci Configurator</a></h4>
            <p class="description">Configure and generate basic software and runtime environment.</p>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
            <div class="icon"><i class="icofont-chart-bar-graph"></i></div>
            <h4 class="title"><a href="">DaVinci Developer</a></h4>
            <p class="description">Design and implement AUTOSAR Software Components.</p>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200">
            <div class="icon"><i class="icofont-earth"></i></div>
            <h4 class="title"><a href="">EB Tresos</a></h4>
            <p class="description">Configure the Microcontroller abstraction layer (MCAL)</p>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="300">
    ...
    <section id="programming_skills" class="skills section-bg">
      <div class="container">
      ...
      <div class="container">
        ...
        <div class="row" data-aos="fade-in">
          ...
          <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
            <div class="info">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d95777.52896916994!2d2.078556485896736!3d41.3947687105026!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12a49816718e30e5%3A0x44b0fb3d4f47660a!2sBarcelona!5e0!3m2!1sen!2ses!4v1593368383949!5m2!1sen!2ses" frameborder="0" style="border:0; width: 100%; height: 250px;" allowfullscreen></iframe>
              </div>
          </div>
        </div>
